<#
.SYNOPSIS
    This PowerShell script ensures that the WN11-SO-000220 vulnerability is remediated. Enforces STIG WN11-SO-000220:
...
.DESCRIPTION
    ...
    NTLMMinServerSec (REG_DWORD) = 0x20080000 (537395200 decimal)

    This ensures NTLMv2 session security and 128-bit encryption are required.
...
.USAGE
    ...
    Example syntax:
    PS C:\> .\WN11-SO-000220_Remediation_Script.ps1
#>
...
$DesiredValue = 0x20080000  # 537395200 decimal
...
Write-Log "Starting STIG enforcement: WN11-SO-000220 - NTLM SSP Minimum Session Security (Servers)..." Cyan
...
if ($CurrentValue -ne $DesiredValue) {
    Write-Log "Setting ${ValueName} to $DesiredValue (Require NTLMv2 and 128-bit encryption)..."
    try {
    ...
    Write-Log "No change required: ${ValueName} already set correctly." Cyan
}
...
Write-Log "Completed STIG enforcement: WN11-SO-000220" Green
